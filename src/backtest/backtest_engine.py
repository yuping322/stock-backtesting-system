...
# 导入基础模块
from src.backtest.backtrader_base_strategy import JQ2BTBaseStrategy
from src.data.data import get_trading_dates, load_bt_stocks, get_index_daily, code2name
# from data_akshare import get_trading_dates, load_bt_stocks, get_index_daily, code2name

from src.metrics.portfolio_structure import structure_metrics
from src.metrics.trade_metrics import trading_metrics
from src.metrics.risk_extension import extended_risk_metrics


# 导入配置模块
try:
    from src.backtest.config import SystemConfig, StrategyConfig, get_strategy_info
...
class AnalysisBuilder:
    ...
    def prepare_overview(
        ...
        for metric in metrics_to_use:
            ...
            if CONFIG_AVAILABLE:
                try:
                    from src.backtest.config import get_metric_info
