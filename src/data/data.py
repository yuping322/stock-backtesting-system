...
INDUSTRY_CSV_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "config", "industry_category.csv")
_industry_df = None
...
# 概念板块（一个代码可对应多个概念）
CONCEPT_CSV_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "config", "concept_category.csv")
_concept_df = None
