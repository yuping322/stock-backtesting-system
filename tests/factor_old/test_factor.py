...
def _import_factor_modules():
    ...
    try:
        from src.factor_old import factor
        from src.factor_old import factor_calculator
        import src.factor_old.factor as factor_module
    except ImportError:
        pass
...
def _safe_import_factor_calculator():
    ...
    try:
        from src.factor_old.factor_calculator import (
        ...
        import src.factor_old.factor_calculator as fc
        return {
...
def _safe_import_factor():
    """安全导入factor模块"""
    try:
        from src.factor_old.factor import (
        ...
        import src.factor_old.factor as ff
        return {
