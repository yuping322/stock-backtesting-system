...
def _safe_import_factor():
    """安全导入factor模块"""
    try:
        from src.factor_old.factor import FactorTestResult
...
class TestMainFactor(unittest.TestCase):
    ...
    def test_save_results(self):
        ...
        from src.factor_old.main_factor import generate_summary_report
    ...
    def test_output_dir_setup(self):
        """测试输出目录设置"""
        from src.factor_old.main_factor import setup_output_dir
