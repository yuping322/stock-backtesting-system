...
# Filter 模式
python examples/factor_selection_basic/generate_final_prediction.py --mode filter --min_events 5 --topk 200 --start 2023-01-01 --end 2024-12-31

# Extend Hold 模式
python examples/factor_selection_basic/generate_final_prediction.py --mode extend_hold --hold_days 3 --bonus_beta 0.5 --topk 200 --start 2023-01-01 --end 2024-12-31

# Two-layer 模式
python examples/factor_selection_basic/generate_final_prediction.py --mode two_layer --sleeve_ratio 0.25 --topk 200 --start 2023-01-01 --end 2024-12-31
```
使用建议：
