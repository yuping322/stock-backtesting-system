...
echo "    --input-csv ../exported_data_all/formatted_data.csv \\"
echo "    --limit-stocks 50"

python convert_sample.py \
    --input-csv ../exported_data_all/formatted_data.csv \
    --limit-stocks 50
...
echo "- 宽表数据: ../exported_data_all/formatted_data.csv"
echo "- 因子数据: ../exported_data_all/features_panel.pkl"
echo "- 标签数据: ../exported_data_all/label_panel.pkl"
echo "- 元数据: ../exported_data_all/meta_series.pkl"
