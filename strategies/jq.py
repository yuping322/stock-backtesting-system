# 克隆自聚宽文章：https://www.joinquant.com/post/63745
# 标题：【实盘数据分享】5年126倍的涨停基因股池轮动
# 作者：实测狂魔~王子玉

# 克隆自聚宽文章：https://www.joinquant.com/post/63558
# 标题：涨停基因+小市值 近6年245倍年化128% 阿尔法1.2
# 作者：wcl2021

# 克隆自聚宽文章：https://www.joinquant.com/post/63484
# 标题：【变种小狮子】带涨停基因的股池轮动V2
# 作者：0xtao
...
def initialize(context):
    ...
    g.stoploss_limit = 0.93  # 止损线0.91
    g.stoploss_market = 0.93  # 市场趋势止损参数
    
    g.HV_control = False #新增，Ture是日频判断是否放量，False则不然
    g.HV_duration = 120*2 #HV_control用，周期可以是240-120-60，默认比例是120
    g.HV_ratio = 0.85    #HV_control用0.9
    g.stockL = []
